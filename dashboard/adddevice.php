...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"><a href="adddevice.php"><i class="fa fa-plus"></i> <span>Add Device</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <form action="/airquality/dashboard/backend/AddDeviceTest.php" method="GET">
                <div class="form-group">
                  <label>Device ID</label>
                  <input type="text" class="form-control" placeholder="Enter Device ID" name="deviceId">
                </div>
                <div class="form-group">
                  <label>User ID</label>
                ...
                <!-- /.box-body -->
                <div>
                  <button type="submit" class="btn btn-info pull-right" >Add Device</button>
                </div>
      </form>
      </div>
        </section>
   	...
   	if($_GET['success'] == -1 && !empty($_GET['success'])){ ?>
   	   <div class="box-body">
              <div class="alert alert-danger alert-dismissible">
                ...
                Error occured while adding the device to database. Please retry.
              </div>
            </div>
   	<?php } else if(!empty($_GET['success'])) { ?>
   	   <div class="box-body">
              <div class="alert alert-info alert-dismissible">
                ...
                Device ID <?php echo $_GET['success']; ?> was suessfully added to the database. 
              </div>
            </div> 
   	<?php } ?>
   	</div>
